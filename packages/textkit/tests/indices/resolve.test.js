...
describe("indices resolve operator", () => {
  ...
  test("should return same indices from simple chars", () => {
    // ex. lorem
    const result = resolve([singleGlyph, singleGlyph, singleGlyph, singleGlyph, singleGlyph]);
  ...
  test("should return correct glyph indices when starting with ligature", () => {
    // ex. firem
    const result = resolve([ligatureGlyph, singleGlyph, singleGlyph, singleGlyph]);
  ...
  test("should return correct glyph indices when contain ligature", () => {
    // ex. lofim
    const result = resolve([singleGlyph, singleGlyph, ligatureGlyph, singleGlyph]);
  ...
  test("should return correct glyph indices when ending in ligature", () => {
    // ex. lorfi
    const result = resolve([singleGlyph, singleGlyph, singleGlyph, ligatureGlyph]);
  ...
  test("should return correct glyph indices when starting with long ligature", () => {
    // ex. ffirem
    const result = resolve([longerLigatureGlyph, singleGlyph, singleGlyph, singleGlyph]);
  ...
  test("should return correct glyph indices when contain long ligature", () => {
    // ex. loffim
    const result = resolve([singleGlyph, singleGlyph, longerLigatureGlyph, singleGlyph]);
  ...
  test("should return correct glyph indices when ending in long ligature", () => {
    // ex. lorffi
    const result = resolve([singleGlyph, singleGlyph, singleGlyph, longerLigatureGlyph]);
  ...
  test("should fill undefined index at start", () => {
    // ex. lorem
    const result = resolve([undefined, singleGlyph, singleGlyph, singleGlyph, singleGlyph]);
  ...
  test("should fill undefined index at middle", () => {
    // ex. lorem
    const result = resolve([singleGlyph, singleGlyph, undefined, singleGlyph, singleGlyph]);
  ...
  test("should fill undefined index at end", () => {
    // ex. lorem
    const result = resolve([singleGlyph, singleGlyph, singleGlyph, singleGlyph, undefined]);
